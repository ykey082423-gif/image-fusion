...
class Evaluator():
    ...
    @classmethod
    def SSIM(cls, imgF, imgA, imgB):
        cls.input_check(imgF, imgA, imgB)
        ssim_A = ssim(imgF, imgA, data_range=1.0)
        ssim_B = ssim(imgF, imgB, data_range=1.0)
        # 必须求平均！
        return (ssim_A + ssim_B) / 2.0
    '''@classmethod
